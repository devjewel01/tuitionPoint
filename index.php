...
<body>
                                    ...
                                    <div class="col-md-4">
                                        <div class="hf-btn">
                                            ...
                                            <button class="btn btn-custom-a"><a class="hireTutor"
                                                    href="tutors/registration.html">Join As
                                                    Tutor</a></button>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <h1 style="font-family: Lucida Sans Unicode;">Search, Learn & Explore!!</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section id="opinion-section" class="opinion-section">
        <div class="container">
            <h2 class="text-center">Tutor`s <span
                style="color:#FF1493; padding: 100px 0; font-size: 60px;
    font-weight: 700;
    padding-bottom: 80px;">Opinion</span> </h2>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="item">
                                <div class="single-info">
                                    <div class="single-info-top">
                                        ...
                                        <p class="lead text-custom-p">Comilla University</p>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h3 style="font-family:Lucida Sans Unicode ">Quick & Convenient</h3>
                    </div>
                </div>
            </div>
    ...
    >Enroll Now<i class="fa fa-arrow-circle-right" aria-hidden="true" ></i></button>
...
*, *::before, *::after 
{
    ...
    <section class="popular-category-area">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="rm-btn">
                        <a href="#" class="mrd-btn">All Categories <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="parents_opinion-section" class="opinion-section">
        <div class="container">
            <h2 class="text-center">Parent`s <span
                style="color:#FF1493; padding: 100px 0; font-size: 60px;
    font-weight: 700;
    padding-bottom: 80px;">Opinion</span></h2>
    ...
    <section id="app-section" class="app-section">
        <div class="container">
            <div class="row">
                ...
                style="color:#FF1493; padding: 100px 0; font-size: 60px;
    font-weight: 700;
    padding-bottom: 80px;">Android App</span></h2>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="">
                                <li class="d-block mb-3">
                                    <a href="tutors/registration.html" class="text-custom-p">Become A
                                        Tutor</a>
                                </li>
                                <li class="d-block mb-3">
                                ...
                                <li class="d-block mb-3">
                                    <a href="ourTeam/contact.html">Contact</a>
                                </li>

                                <li class="d-block mb-3">
                                    <a href="terms-condition/" >FAQ</a>
                                </li>
                                <li class="d-block mb-3">
                        ...
                        <div class="col-md-6">
                            <ul class="#">
                                ...
                                <li class="d-block mb-3">
                                    <a href="ourTeam/" class="text-custom-p">Our Team</a>
                                </li>
                                <li class="d-block mb-3">
                                    <a href="https://github.com/devjewel01/tuitionPoint" class="text-custom-p">Contribution</a>
                                </li>
                                <li class="d-block mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="text-custom-p text-left p-0">
                                ...
                                <li class="d-block mb-3 footer-contact">
                                    ...
                                    <a href="#" class="text-custom-p ml-2">01874280811</a>
                                    <hr>
                                </li>
                                <li class="d-block mb-3 footer-contact">
